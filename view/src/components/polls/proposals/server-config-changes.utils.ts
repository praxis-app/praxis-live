...
export const SERVER_CONFIG_FIELDS = [
  'anonymousUsersEnabled', 'decisionMakingModel', 'disagreementsLimit',
  'abstainsLimit', 'agreementThreshold', 'quorumEnabled', 'quorumThreshold',
  'votingTimeLimit',
] as const;
...
) => Object.fromEntries(SERVER_CONFIG_FIELDS.flatMap((field) =>
